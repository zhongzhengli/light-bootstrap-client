...
- Renamed `client/routes/app.jsx` to `client/routes/dashboard.jsx`
- Renamed `appRoutes` to `dashboardRoutes`
- Added `client/routes/index.jsx` and made the routes in `client/index.js` dynamically based on `indexRoutes` from `client/routes/index.jsx` (users can now make new layouts and routes for them easier)
...
- `bootstrap@3.3.7` (and deleted `client/assets/bootstrap.min.css?v=3.3.5`)
### Update dependencies
